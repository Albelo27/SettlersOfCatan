...
public class DoNotTouch {
    ...
    public final float[] vertexList = {X[2], Y[1], X[3], Y[0], X[4], Y[1], X[4], Y[2], X[3], Y[3], X[2], Y[2],
            ...
            X[6], Y[1], X[7], Y[0], X[8], Y[1], X[8], Y[2], X[7], Y[3], X[6], Y[2],
            X[1], Y[3], X[3], Y[4], X[2], Y[5], X[1], Y[4], X[5], Y[4], X[4], Y[5],
            X[7], Y[4], X[6], Y[5], X[9], Y[4], X[8], Y[5], X[9], Y[3],
            X[0], Y[5], X[2], Y[6], X[1], Y[7], X[0], Y[6],  X[4], Y[6], X[3], Y[7],
            X[6], Y[6], X[5], Y[7], X[8], Y[6], X[7], Y[7],  X[10], Y[5], X[10], Y[6], X[9], Y[7],
            X[3], Y[8], X[2], Y[9], X[1], Y[8], X[5], Y[8], X[4], Y[9], X[7], Y[8], X[6], Y[9],
            X[9], Y[8], X[8], Y[9], X[4], Y[10], X[3], Y[11], X[2], Y[10], X[6], Y[10], X[5], Y[11],
            X[8], Y[10], X[7], Y[11]};
